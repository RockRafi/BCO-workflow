...
import { LayoutDashboard, PlusCircle, LogOut, FileText, Layers, Settings as SettingsIcon, Bell } from 'lucide-react';
...
const Layout: React.FC<LayoutProps> = ({ children, currentUser, onLogout, currentView, onChangeView }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-row font-sans">
      {/* Sidebar Navigation Rail - Reverted to Light Theme */}
      ...
      <main className="flex-1 overflow-auto relative">
        {/* Abstract Background Pattern (Original Style) */}
